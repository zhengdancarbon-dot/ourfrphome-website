...
fs.writeFileSync(path.join(reportDirectory, "priority-product-performance.csv"), csv(productPerformance, ["id", "name", "path", "gscImpressions", "gscClicks", "gscCtr", "gscPosition", "yandexImpressions", "yandexClicks", "yandexPosition", "pageViews", "rfqSubmit", "tdsDownload", "catalogDownload", "emailClick", "whatsappClick", "recordedRfqs", "qualifiedRfqs"]));
...
console.log(JSON.stringify({ gscRows: gsc.length, ga4Rows: ga4.length, yandexRows: yandex.length, salesRows: sales.length, observationDays, priorityProducts: productPerformance.length, decisionQueue: decisionQueue.length }));
