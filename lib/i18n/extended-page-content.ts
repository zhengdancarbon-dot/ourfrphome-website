...
const russianPriorityProductCopy: Partial<Record<ProductSlug, DualCoreCopy>> = {
  "carbon-fiber-yarn-and-tow": {
    ...
    faqs: [{ question: "Какие размеры углеродного жгута можно запросить?", answer: "В запросе можно указать 1K, 3K, 6K, 12K, 24K или 50K. Фактическая поставка подтверждается по марке, партии, аппрету, количеству и назначению." }, { question: "Какие данные нужны для предложения?", answer: "Укажите размер жгута, марку волокна, аппрет, совместимый процесс, массу бобины, количество, конечное применение и страну назначения." }],
  },
  "carbon-fiber-ud-fabric": {
    ...
    faqs: [{ question: "Есть ли TDS для ткани UD 300gsm?", answer: "Да. На странице доступен TDS для ткани UD 300gsm. Окончательная спецификация подтверждается для заказа и партии." }, { question: "Что указать в запросе?", answer: "Укажите марку волокна, g/m², ширину, направление волокон, смоляной процесс, количество, проект и страну назначения." }],
  },
  "structural-strengthening-system": {
    ...
    faqs: [{ question: "Когда выбирать ткань UD, а когда ламель CFRP?", answer: "Выбор зависит от геометрии, основания, направления нагрузки, проектной схемы и способа монтажа. Решение должен подтвердить квалифицированный инженер." }, { question: "Какие данные нужны для предложения?", answer: "Укажите тип сооружения, основание, проектную площадь, ткань или ламель, размеры, эпоксидную систему, количество, страну назначения и доступные проектные документы." }],
  },
  "carbon-fiber-woven-fabric": {
    ...
    faqs: [{ question: "Есть ли TDS для саржевой ткани 3K 200gsm?", answer: "Да. На странице доступен TDS для саржевой ткани 3K 200gsm. Ширина, рулон и спецификация заказа подтверждаются отдельно." }, { question: "Какие данные нужны для предложения?", answer: "Укажите размер жгута, переплетение, g/m², ширину, длину рулона, смоляной процесс, количество, конечное применение и страну назначения." }],
  },
};
