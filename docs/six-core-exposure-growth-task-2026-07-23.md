...
38. Added a localized six-product priority section to the ES, PT-BR, RU, AR, FR, KO, PL and TR Products directories. Each route now leads buyers to the six stable commercial pages before the complete family directory, using localized headings, product text and CTA copy while preserving technical tokens, canonical tags and hreflang. The sitemap records the real 2026-07-27 update date for all nine Products directories and now rounds localized priority values cleanly. Build, 210-URL SEO audit, eight-directory link checks, Spanish desktop and Arabic RTL mobile QA passed. Vercel Preview `dpl_BryrUdikoL61q9M7QK3L3x9kEpkX` is Ready and generated 219 routes. Evidence is recorded in `docs/six-core-localized-products-priority-2026-07-27.md`.
39. Added the same six-product procurement hierarchy to the English Products directory, before the complete product-family listing. The section reuses the six stable commercial URLs and existing product descriptions, and adds an `ItemList` entity containing names, order and canonical URLs only; no offer, price, inventory, rating or unsupported property was added. Build, 210-URL SEO audit, six-link/schema checks and desktop/mobile QA passed. Vercel Preview `dpl_EsyDCT8N6EggWgQZF3LuF9fgVDqN` is Ready and generated 219 routes. Evidence is recorded in `docs/six-core-english-products-priority-2026-07-27.md`.
40. Added localized six-product `ItemList` entities to the ES, PT-BR, RU, AR, FR, KO, PL and TR Products directories. Each entity uses the localized title, product names, language code and canonical localized product URLs in the shared commercial-priority order. The audit now blocks missing lists, incorrect counts or languages, missing localized URLs and exact English-name fallback. No offer, price, inventory, rating, review or unsupported property was added. Build and the complete 210-URL production-mode audit passed. Vercel Preview `dpl_2S8EvEVJsg73ZSjieqYRtb6H67jv` is Ready and generated all 219 routes. Evidence is recorded in `docs/six-core-localized-itemlist-schema-2026-07-27.md`.
41. Completed interactive browser QA against the production build from the exact Preview commit because direct `vercel.app` page access remains unavailable from the automation network. The 1440x900 English Products directory, 390x844 Arabic RTL Products directory, mobile product menu, nine-language switcher, NCF video/TDS/download attributes, product-image zoom and Spanish RFQ locale/source/UTM fields passed without horizontal overflow or console errors. No external RFQ email was sent without action-time approval. Evidence is recorded in `docs/six-core-preview-browser-qa-2026-07-27.md`.
